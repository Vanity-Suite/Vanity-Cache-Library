...
public class LZMACompressor {
	 ...
	 */
	public static byte[] decompress(com.github.vanity.io.impl.InputStream buffer, int decompressedLength) {
		com.github.vanity.io.impl.OutputStream output = new com.github.vanity.io.impl.OutputStream(buffer.getRemaining());
