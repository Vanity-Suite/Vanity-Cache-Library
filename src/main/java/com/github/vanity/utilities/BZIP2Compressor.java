package com.github.vanity.utilities;

import com.github.apache.tools.bzip2.CBZip2OutputStream;
...
public class BZIP2Compressor {
	...
	public static byte[] decompress317(int decompressedLength, int compressedLength, com.github.vanity.io.impl.InputStream inputStream) {
	...
	public static void decompress(BZIP2BlockEntry bzip2BlockEntry) {
		...
		while (bool_28_) {
			...
			for (int i_31_ = 0; i_31_ < 16; i_31_++) {
				i_29_ = method153(bzip2BlockEntry);
				bzip2BlockEntry.aBooleanArray3072[i_31_] = i_29_ == 1;
			}
			...
			System.arraycopy(bzip2BlockEntry.anIntArray3075, 0, bzip2BlockEntry.anIntArray3091, 1, 256);
