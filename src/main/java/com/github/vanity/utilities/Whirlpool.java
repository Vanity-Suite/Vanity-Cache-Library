...
public class Whirlpool
{
	...
	private static final long[][] aLongArrayArray8 = new long[8][256];
	private static final long[] aLongArray9 = new long[11];
	...
	protected void processBuffer() {
		...
		for (int r = 1; r <= 10; r++) {
			...
			System.arraycopy(aLongArray11, 0, aLongArray10, 0, 8);
			...
			System.arraycopy(aLongArray11, 0, state, 0, 8);
		}
		for (i = 0; i < 8; i++) {
