package com.github.vanity;

import com.github.vanity.cache.index.ChecksumTable;
import com.github.vanity.cache.index.Index;
import com.github.vanity.cache.index.Index317;
...
public class CacheLibrary {
	...
	public void removeLastIndex() {
		try {
			...
			checksumTable.getRandomAccessFile().truncate((long) id * Constants.INDEX_SIZE);
